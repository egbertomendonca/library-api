...
public class BookController {
    ...
    public BookDTO get( @PathVariable Long id ){
        return service
                ...
                .orElseThrow( () -> new ResponseStatusException(HttpStatus.MULTI_STATUS.NOT_FOUND));
    }
    ...
    public void delete(@PathVariable Long id){
        Book book = service.getById(id).orElseThrow( () -> new ResponseStatusException(HttpStatus.MULTI_STATUS.NOT_FOUND));
        service.delete(book);
    }
